...
import questionsMama from "../data/FiscalitateSiGestiuneContabila.json";
...
const TestFSCG: React.FC = () => {
  ...
  const handleStartNew = () => {
    navigate("/testFSCG", { replace: true });
        ...
        selectedQuestions[currentQuestionIndex] ? (
          <>
            <Typography variant="h6" component="h1" gutterBottom align="center">
              Test Fiscalitate și Gestiune Contabilă
            </Typography>
