...
import questionsMama from "../data/evaluareaIntreprinderii.json";
...
const EvaluareaIntreprinderii: React.FC = () => {
  ...
  const handleStartNew = () => {
    navigate("/evaluareaIntreprinderii", { replace: true });
...
export default EvaluareaIntreprinderii;
