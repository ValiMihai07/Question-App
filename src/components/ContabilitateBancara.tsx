...
import questionsMama from "../data/contabilitateBancara.json";
...
const ContabilitateBancara: React.FC = () => {
  ...
  const handleStartNew = () => {
    navigate("/contabilitateBancara", { replace: true });
...
export default ContabilitateBancara;
