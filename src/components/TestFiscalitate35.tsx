...
import questionsMama from "../data/fiscalitate35.json";
...
const TestFiscalitate35: React.FC = () => {
  ...
  const handleStartNew = () => {
    navigate("/testFiscalitate35", { replace: true });
...
export default TestFiscalitate35;
