...
import questionsMama from "../data/examenFinal.json";
import FinalReviewMama from "./FinalReview/finalReviewMama";
...
const TestExamenFinal: React.FC = () => {
  ...
  useEffect(() => {
    const formattedQuestions = (questionsMama as RawQuestion[]).map((q) => ({
      question: q.question,
      answers: q.answers,
  ...
  const handleStartNew = () => {
    navigate("/testExamenFinal", { replace: true });
...
export default TestExamenFinal;
