...
import questionsMama from "../data/controlDeGestiune.json";
...
const ControlDeGestiune: React.FC = () => {
  ...
  const handleStartNew = () => {
    navigate("/controlDeGestiune", { replace: true });
...
export default ControlDeGestiune;
