...
import questionsMama from "../data/analizaFluxFinanciar.json";
        ...
        selectedQuestions[currentQuestionIndex] ? (
          <>
            <Typography variant="h6" component="h1" gutterBottom align="center">
              Test Analiza Fluxului Financiar
            </Typography>
