...
import questionsMama from "../data/ContabilitateaTranzactiilorInternationale.json";
        ...
        selectedQuestions[currentQuestionIndex] ? (
          <>
            <Typography variant="h6" component="h1" gutterBottom align="center">
              Test Contabilitatea Tranzacțiilor Internaționale
            </Typography>
